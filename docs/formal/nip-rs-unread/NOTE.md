...
(below): every context ID Pkzz actually generates (channel UUID,
...
**Cost:** zero bytes for every context ID Pkzz generates today (channel
...
">256-byte key drop hazard" section: Pkzz's own key shapes cannot
