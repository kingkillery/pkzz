...
# Installed Pkzz state is preserved.
# =============================================================================
set -euo pipefail
...
if [[ "${1:-}" != "--yes" ]]; then
  ...
  echo -e "   Installed Pkzz app state and its production keyring are preserved."
...
success "Desktop development state removed (installed Pkzz state preserved)"
