//! Harness-side Pkzz relay client.
//!
//! Connects to the Pkzz relay via NIP-01 WebSocket, authenticates via NIP-42,
...
///
/// Connects to the Pkzz relay, authenticates via NIP-42, and streams
