//! `buzz-test-cli` — Manual testing CLI for the Pkzz relay.
//!
//! # Usage
//!
//! ```text
...
//! Send a message:
//! ```text
//! buzz-test-cli --channel my-channel --send "Hello, Pkzz!"
//! ```
//!
...
fn print_help() {
    println!(
        r#"buzz-test-cli — Manual testing CLI for the Pkzz relay
