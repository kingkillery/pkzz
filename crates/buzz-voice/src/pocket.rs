//! April 2026 Pocket TTS engine for Pkzz Desktop.
//!
...
//! Pkzz selects the upstream three-graph INT8 variant while retaining the
...
/// Load Pkzz Desktop's pinned April INT8 model.
