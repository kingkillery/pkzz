...
//! (OPS metadata) and tells Pkzz where to find personas, hooks, and MCP
//! config.
//!
//! ```json
//! {
...
pub struct Engines {
    /// Semver range the Pkzz runtime must satisfy (e.g. `">=0.9.0"`).
...
/// validator issues advisory warnings for Pkzz-unknown keys.
