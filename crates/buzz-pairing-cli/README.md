...
## Testing Against a Local Pkzz Relay

The CLI supports NIP-42 authentication, so it works with Pkzz relays out of the box.

### Prerequisites

- Docker running (for Postgres, Redis, etc.)
- Pkzz relay built: `cargo build --release -p buzz-relay`
