...
/// Name of the first-party Pkzz theme. Pkzz reuses the GitHub Light palette for
...
/// the two behave as a single "Pkzz" choice under System mode.
const buzzDarkThemeName = 'buzz-dark';

/// Whether [themeName] is either half of the Pkzz pair. Both halves enable the
...
/// Whether the current widget tree is using the first-party Pkzz treatment.
...
///
/// Every theme uses its own [ColorScheme.onSurface]. Pkzz is the exception:
...
///
/// Section labels need more hierarchy than a placeholder. Pkzz therefore uses
...
/// Pkzz renders with its fixed neutral foreground while preserving the stored
...
/// The Pkzz gradient for the app's top section, or null when [themeName] is not
/// a Pkzz theme — in which case the section keeps its default frosted fill.
///
/// The stops are fully opaque: under Pkzz the color replaces the frosted
