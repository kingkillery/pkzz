...
///
/// Includes the attribution sidecar written by Pkzz during install. The
...
(https://github.com/k2-fsa/sherpa-onnx); Pkzz ships this conversion
unmodified.
...
impl ModelManager {
    ...
    ///   - upstream `LICENSE` plus Pkzz's `MODEL_LICENSE.txt` attribution sidecar
