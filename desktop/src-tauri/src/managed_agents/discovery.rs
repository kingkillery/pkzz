...
// `custom_harnesses` reaches for the id/definition projections through
// `discovery::` — keep them re-exported so the preset table's move into a
// submodule stays invisible to callers.
