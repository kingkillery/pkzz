...
pub(crate) const PRESET_HARNESSES: &[PresetHarness] = &[
    PresetHarness {
        ...
        install_hint: "Pkzz talks to Devin through the official Devin CLI's ACP mode (devin acp).",
        underlying_cli: None,
        login_hint: None,
    },
    PresetHarness {
    ...
    PresetHarness {
        ...
        install_hint: "Pkzz talks to Oh My Pi through its CLI's ACP mode (omp acp).",
        underlying_cli: None,
        login_hint: None,
    },
    PresetHarness {
        ...
        install_hint: "Pkzz talks to Grok Build through its CLI's agent stdio mode.",
        underlying_cli: None,
        login_hint: None,
    },
    PresetHarness {
        ...
        install_hint: "Pkzz talks to OpenCode through its CLI's ACP mode (opencode acp).",
        underlying_cli: None,
        login_hint: None,
    },
    PresetHarness {
        ...
        install_hint: "Pkzz talks to Kimi Code through its CLI's ACP mode (kimi acp).",
        underlying_cli: None,
        login_hint: None,
    },
    PresetHarness {
        ...
        install_hint: "Pkzz talks to the Amp CLI through the amp-acp adapter. Follow the setup guide to install the adapter so the amp-acp command is on your PATH.",
    ...
    PresetHarness {
        ...
        install_hint: "Pkzz talks to Hermes Agent through its hermes-acp command.",
        underlying_cli: None,
        login_hint: None,
    },
    PresetHarness {
        ...
        install_hint: "Pkzz talks to OpenClaw through its ACP mode (openclaw acp), which relies on the OpenClaw Gateway daemon. Follow the setup guide to install both.\n\n\
