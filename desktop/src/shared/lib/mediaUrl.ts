 ...
 *
 * Only URLs hosted on the Pkzz relay are rewritten. External Blossom URLs
 ...
 * (the Pkzz relay), resulting in 404s.
 */
...
/**
 * If `url` is a Blossom media URL hosted on the Pkzz relay, rewrite it
