...
export function hostedCommunityErrorMessage(
  ...
  const messages: Record<string, string> = {
    missing_mapping: "Connect your Pkzz identity before creating a community.",
    invalid_name: "Use lowercase letters, numbers, and hyphens.",
    taken: "That Pkzz address is already taken.",
    ...
    identity_already_bound:
      "This Builderlab account is connected to another Pkzz identity.",
    pubkey_already_bound:
      "This Pkzz identity is connected to another Builderlab account.",
    not_owner: "Only the community owner can do that.",
    transferee_not_registered:
      "That person needs a connected Pkzz identity before you can transfer ownership to them.",
  };
