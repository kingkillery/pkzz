...
test("Pkzz shared compute explains automatic model selection", async ({
  page,
}) => {
  await page.goto("/");
  await page.evaluate(() => {
...
test("create agent persists Pkzz shared compute with auto model", async ({
  page,
}) => {
