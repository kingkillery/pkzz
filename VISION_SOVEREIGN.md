...
Next to it, a "Connect on Pkzz" button.
...
You hit "Connect on Pkzz" and the app opens. You're in `#general`. The team is
...
"Connect on Pkzz" and they're in the community. No separate onboarding flow. No
...
portable even when the hosting isn't. And you can use Pkzz as a collaboration
layer on top of GitHub if that's what makes sense — work in Pkzz channels, push
...
Someone picks up the bug. They create a branch. Pkzz creates a channel:
...
things are announcements. Some things are essays. Pkzz has surfaces for both,
...
Onboarding friction is real — not insurmountable, but real. The "Connect on Pkzz"
